...
This library is completely open source and contribution to this tool is highly encouraged for everyone! If you have found any issues during your usage of this program, please submit an issue and I'll go back to you right away.
...
- Before you submit your pull request, ensure that you have written unit-tests.
- Don't forget to test your code first by using `go test -v -cover ./... ./...`.
